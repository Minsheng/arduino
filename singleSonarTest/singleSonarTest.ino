...
const int servoPin = 3; // the digital pin used for the servo
...
void loop() {
  ...
  myservo.write(180,60,true);        // move the servo to 180, max speed, wait until done
                                      // write(degrees 0-180, speed 1-255, wait to complete true-false)
  myservo.write(0,60,true);           // move the servo to 180, slow speed, wait until done
}
