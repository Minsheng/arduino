...
const int motorRPin1 = 11; // signal pin 1 for the right motor, connect to IN1               
const int motorRPin2 = 12;  // signal pin 2 for the right motor, connect to IN2
const int motorREnable = 6; // enable pin for the right motor (needs to be PWM enabled)

const int motorLPin1 = 9; // signal pin 1 for the left motor, connect to IN3 (was 5 - need to change)             
const int motorLPin2 = 8; // signal pin 2 for the left motor, connect to IN4
const int motorLEnable = 5; // enable pin for the left motor (needs to be PWM enabled)
